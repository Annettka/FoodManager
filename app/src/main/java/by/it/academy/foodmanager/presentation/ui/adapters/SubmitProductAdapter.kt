...
import by.it.academy.foodmanager.presentation.ui.fragments.SubmitProductFragmentDirections

class SubmitProductAdapter :
    ListAdapter<ProductCategoryPresent, SubmitProductAdapter.SubmitProductViewHolder>(
        ProductDiffCallback()
    ) {
...
private class ProductDiffCallback : DiffUtil.ItemCallback<ProductCategoryPresent>() {

    override fun areItemsTheSame(
        oldItem: ProductCategoryPresent,
        newItem: ProductCategoryPresent
    ): Boolean {
